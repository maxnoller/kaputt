...
namespace NOBRAIN.KAPUTT.ConnectionManagement
{
    class HostState : OnlineState
    {
        ...
        public override void Enter()
        {
            ...
            //The "BossRoom" Host always advances to CharSelect immediately on start. Different games
            //may do this differently.
            SceneLoaderWrapper.Instance.LoadScene("battlefield", useNetworkSceneManager: true);
        }
        ...
        {
            //TODO: Refactor remove session data
        ...
        /// clients shouldn't send it private authentication tokens you'd usually send to a dedicated Host.
        /// </remarks>
        ...
        public override void ApprovalCheck(NetworkManager.ConnectionApprovalRequest request, NetworkManager.ConnectionApprovalResponse response)
        {
            ...
            {
                // If connectionData too high, deny immediately to avoid wasting time on the Host. This is intended as
