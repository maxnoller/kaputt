...
namespace NOBRAIN.KAPUTT.Editor
{
    /// <summary>
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "KAPUTT/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "KAPUTT/Don't Load Bootstrap Scene On Play";
